...
const roles = [
  ...
  },
  {
    id: 'admin',
    title: 'Administrator',
    description: 'I manage the organ donation system',
    icon: Shield,
  ...
  const updateRoleMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: "Welcome to the organ donation management system!",
      });
    },
    onError: (error: any) => {
      toast({
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="max-w-4xl w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-2">Welcome to Organ Donation Management</h1>
